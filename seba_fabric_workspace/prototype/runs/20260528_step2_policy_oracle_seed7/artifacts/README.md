# Run 20260528_step2_policy_oracle_seed7

Purpose: Step 2 deterministic policy oracle and basic XAI explanation generation.

Input run: `20260528_step1_synthetic_requests_seed7`
...
python3 prototype/synthetic_access_sim/policy_oracle.py \
  --input-run-id 20260528_step1_synthetic_requests_seed7 \
  --run-id 20260528_step2_policy_oracle_seed7
```
