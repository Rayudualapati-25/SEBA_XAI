# Run 20260528_step3_audit_baselines_seed7

Purpose: Step 3 mutable-log and signed hash-chain audit baselines.

Input run: `20260528_step2_policy_oracle_seed7`
...
python3 prototype/synthetic_access_sim/audit_baseline.py \
  --input-run-id 20260528_step2_policy_oracle_seed7 \
  --run-id 20260528_step3_audit_baselines_seed7
```
