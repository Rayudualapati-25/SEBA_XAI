# Run 20260528_step4_permissioned_blockchain_audit_seed99

Purpose: Step 4 permissioned blockchain-style audit simulation.

Input run: `20260528_step3_audit_baselines_seed99`
...
python3 prototype/synthetic_access_sim/blockchain_audit.py \
  --input-run-id 20260528_step3_audit_baselines_seed99 \
  --run-id 20260528_step4_permissioned_blockchain_audit_seed99
```
